  ...
  return (
    <SafeAreaView>
      <View style={{flexDirection:'column', marginBottom: 26 }}>
        <View style={{marginBottom: 4}}><Text style={TextStyle.h2}>Xác thực Email</Text></View>
        <Text style={[TextStyle.h4, {color: Color.grey_100}]}>Nhập mã OTP được gửi đến email của bạn</Text>
      </View>
      <OTPInput
      label={props.title}
      value={OTP}
    ...
    />
      ...
      <Text style={TextStyle.h4}>
        <Text style={{color: Color.grey_100}}>Bạn chưa nhận được mã OTP? </Text>
